...
//    }
    ...
    public ArrayList<String> choseInitialLeaderCards(ArrayList<String> leaderCardsIDs, int numberOFLeaderCardsToChose) {
        ...
        if (response.equals("YES") || response.equals("Y")) {
            ...
            return leaderCardsChosen.keySet().stream().collect(Collectors.toCollection(ArrayList::new));
        } else return choseInitialLeaderCards(leaderCardsIDs, numberOFLeaderCardsToChose);
    }

    // test for choseInitialLeaderCards()
  /*  public static void main(String[] args) {
        String player = "PAOLO";
    ...
    @Override
    public HashMap<Resource, Integer> choseResources(ArrayList<Resource> allResources, int numberOFResourcesToChose) {
...
//      THIS IS THE MAIN TO TEST getWarehouseDisplacement()
//
//    public static void main(String[] args) {
